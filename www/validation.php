...
switch ($action) {
    ...
    case 'ajout_produit':
        ...
        $PRO_lib = (!empty($_POST['PRO_lib'])) ? "'" . mysqli_real_escape_string($link, $_POST['PRO_lib']) . "'" : 'null';
        $PRO_description = (!empty($_POST['PRO_description'])) ? "'" . mysqli_real_escape_string($link, $_POST['PRO_description']) . "'" : 'null';
        $PRO_prix = (!empty($_POST['PRO_prix'])) ? "'" . mysqli_real_escape_string($link, str_replace(',', '.', $_POST['PRO_prix'])) . "'" : 'null';
    ...
    case 'modification_produit':
        ...
        $PRO_id = (!empty($_POST['PRO_id'])) ? "'" . mysqli_real_escape_string($link, $_POST['PRO_id']) . "'" : 'null';
        $PRO_lib = (!empty($_POST['PRO_lib'])) ? "'" . mysqli_real_escape_string($link, $_POST['PRO_lib']) . "'" : 'null';
        $PRO_description = (!empty($_POST['PRO_description'])) ? "'" . mysqli_real_escape_string($link, $_POST['PRO_description']) . "'" : 'null';
        $PRO_prix = (!empty($_POST['PRO_prix'])) ? "'" . mysqli_real_escape_string($link, str_replace(',', '.', $_POST['PRO_prix'])) . "'" : 'null';
